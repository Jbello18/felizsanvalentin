...
window.addEventListener("load", () => {
  ...
  if (anniversaryDate) {
    ...
    document.getElementById(
      "daysCount"
    ).innerText = `Ya han pasado 1 año, desde que comenzó esta historia tan linda llena de muchas cosas, de experiencas, de recuerdos me alegra mucho estar a tu lado ahora y por siempre disfrutar cada momento cuando estamos juntos, eres la persona que amaré de por vida. ¡Te Amoo❤️!`;
  }
});
...
const mensajes = [
    ...
    "Eres la felicidad en mi vida. ☀️",
    "Eres mi vida. 💗",
    "Eres mi cielo. ❤️‍🩹",
    "Eres mi princesa. 👸🏻",
    "Eres mi corazon preciosa. ❤️",
    "Eres el ser mas hermosa que tengo conmigo. 💓",
    "Mi chica ideal. 👩🏻",
];
